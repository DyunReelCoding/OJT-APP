...
const StatCard = ({ count = 0, label, icon }: StatCardProps) => {
  return (
    <div className="flex justify-center items-center w-full">
      <div
        className={clsx(
          "p-6 rounded-xl shadow-lg flex flex-col justify-between items-center bg-gradient-to-r from-blue-200 to-blue-700 text-white w-full max-w-sm min-w-0 h-32"
        )}
      >
